# encoding: utf-8
# module cmath
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/cmath.cpython-37m-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x102f1b6d8>'

__spec__ = None # (!) real value is "ModuleSpec(name='cmath', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x102f1b6d8>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/cmath.cpython-37m-darwin.so')"
