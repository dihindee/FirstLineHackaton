# encoding: utf-8
# module _struct
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_struct.cpython-37m-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10b107da0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_struct', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10b107da0>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_struct.cpython-37m-darwin.so')"
