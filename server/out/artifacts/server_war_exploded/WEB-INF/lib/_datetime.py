# encoding: utf-8
# module _datetime
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_datetime.cpython-37m-darwin.so
# by generator 1.147
...
datetime_CAPI = None # (!) real value is '<capsule object "datetime.datetime_CAPI" at 0x10f2b51b0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10f6bf6a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_datetime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10f6bf6a0>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_datetime.cpython-37m-darwin.so')"
