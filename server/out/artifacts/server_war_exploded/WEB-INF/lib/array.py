# encoding: utf-8
# module array
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/array.cpython-37m-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10f34f6a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='array', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10f34f6a0>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/array.cpython-37m-darwin.so')"
