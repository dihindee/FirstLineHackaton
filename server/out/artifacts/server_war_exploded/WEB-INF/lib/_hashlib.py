# encoding: utf-8
# module _hashlib
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_hashlib.cpython-37m-darwin.so
# by generator 1.147
# no doc
# no imports
...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha224', 'sha512', 'sha1', 'md4', 'blake2b512', 'sha256', 'blake2s256', 'whirlpool', 'ripemd160', 'md5-sha1', 'md5', 'sha384'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10bf99278>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10bf99278>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_hashlib.cpython-37m-darwin.so')"
