# encoding: utf-8
# module _heapq
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_heapq.cpython-37m-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x1060796d8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_heapq', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x1060796d8>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/_heapq.cpython-37m-darwin.so')"
