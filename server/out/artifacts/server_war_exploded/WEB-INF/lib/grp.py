# encoding: utf-8
# module grp
# from /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/grp.cpython-37m-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10476bc18>'

__spec__ = None # (!) real value is "ModuleSpec(name='grp', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10476bc18>, origin='/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/lib-dynload/grp.cpython-37m-darwin.so')"
